...
**Provincial data: Western Cape, Mpumalanga and KwaZulu-Natal land cover**

Western Cape Provincial Land Cover (supplied by Cape Nature, 2022). Data supplied in ESRI GRID format, converted to a TIFF in ARCGIS PRO, 10 m data (UTM34S) resampled to match 20m and Albers Equal Area national land cover grid. Reclassified to match the NLC classes.

KwaZulu-Natal Provincial Land Cover (supplied by Ezemvelo KZN Wildlife, 2017). Data supplied in ESRI gdb format, converted to a TIFF in ARCGIS PRO, 20 m data (UTM35S) resampled to match 20m and Albers Equal Area national land cover grid. Reclassified to match the NLC classes.

Mpumalanga Provincial Land Cover (supplied by MPTA, 2017). Data supplied in ESRI gdb format, converted to a TIFF in ARCGIS PRO, 20 m data (UTM35S) resampled to match 20m and Albers Equal Area national land cover grid. Reclassified to match the NLC classes.
...
**Subtropical Ecosystem Project (STEP) thicket ecosystem condition**
...
**Little Karoo ecosystem condition (Thompson 2009)**
...
**Hardeveld degradation study and ecosystem condition**
...
**Little Karoo degradation study and ecosystem condition (Kirsten 2023)**
...
The 8 class NLC is combined with each condition layer sequentially such that if the 8 class NLC VALUE = 1 and the condition layer VALUE = 8, then the pixel is recoded to VALUE = 9 (poor condition/severe degradation).
